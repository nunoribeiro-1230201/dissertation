...
\begin{figure}
    ...
    \caption[State Diagram of Nodes in Raft]{Diagram illustrating the states of a node in the Raft algorithm \footnotemark.}
...
This strategies focuses more on the recovery part of the faults, so they actuate over an error. This strategies have the goal to recover a error-free state \cite{Tanenbaum2023}. 
