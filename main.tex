...
\thesistitle{Comparative Analysis of Fault Tolerance in Elixir, Scala with Akka, and Go}
...
\input{ch-intro/chapter-intro.tex}
\input{ch-background/chapter-background.tex}
\input{ch-state/chapter-state.tex}
\input{ch-planning/chapter-planning.tex}
